...
const Photo = () => {
  return (
    <div>
      ...
      >
        {/* image profile */}
        {/* <Image src='/angel/profile.png' height={580} width={580} alt='profile' className='inset-0  z-40 object-contain xl:translate-y-[3px]'/> */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{
            opacity: 1,
        ...
        >
          <Image
            src="/angel/profile1.png"
            height={500}
            width={500}
            alt="profile"
            className="inset-0  z-50 object-contain xl:translate-y-[3px] rounded-full"
            quality={100}
          />
        </motion.div>
        <motion.div
